...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        self.show_vehicle_telemetry = True
...
class RadarSensor(object):
    def __init__(self, parent_actor):
        self.sensor = None
        self._parent = parent_actor
        bound_x = %radar_x_position% + self._parent.bounding_box.extent.x
        bound_y = %radar_y_position% + self._parent.bounding_box.extent.y
        bound_z = %radar_z_position% + self._parent.bounding_box.extent.z
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        bound_x = %camera_manager_x_position% + self._parent.bounding_box.extent.x
        bound_y = %camera_manager_y_position% + self._parent.bounding_box.extent.y
        bound_z = %camera_manager_z_position% + self._parent.bounding_box.extent.z
        ...
        self.sensors = [
            ...
            ['sensor.lidar.ray_cast', None, 'Lidar (Ray-Cast)', {'range': '%lidar_raycast_range%'}],
            ['sensor.camera.dvs', cc.Raw, 'Dynamic Vision Sensor', {}],
            ['sensor.camera.rgb', cc.Raw, 'Camera RGB Distorted',
                {'lens_circle_multiplier': '10.0',
                'lens_circle_falloff': '10.0',
                'chromatic_aberration_intensity': '10.5',
                'chromatic_aberration_offset': '10'}],
